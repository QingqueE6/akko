<x-layout>
    ...
    <div class="text-white grid grid-cols-1">
        ...
        <a href="/archive/games" class="m-1 pl-1 bg-gradient-to-r from-emerald-400 via-emerald-200 to-white hover:opacity-50 shadow-md font-bold custom-text-shadow">
            Games
        </a>
    </div>
</x-layout>